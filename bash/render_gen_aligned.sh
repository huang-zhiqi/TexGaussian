...
MANIFEST_PATH="../experiments/texverse_stage1_new_modules_v10_middle/generated_manifest.tsv"
...
# 输出目录
OUT_ROOT="../experiments/texverse_stage1_new_modules_v10_middle/texverse_gen_renders"
