...
MANIFEST_PATH="../experiments/texverse_v14_fid_optimized_mini/generated_manifest.tsv"
...
# 输出目录
OUT_ROOT="../experiments/texverse_v14_fid_optimized_mini/texverse_gen_renders"
