...
MANIFEST_PATH="../experiments/texgaussian_baseline_long_LongCLIP_2GPU/generated_manifest.tsv"
...
# 输出目录
OUT_ROOT="../experiments/texgaussian_baseline_long_LongCLIP_2GPU/texverse_gen_renders"
