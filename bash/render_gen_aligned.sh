...
MANIFEST_PATH="../experiments/texverse_stage1_new_modules_v3/generated_manifest.tsv"
...
# 输出目录
OUT_ROOT="../experiments/texverse_stage1_new_modules_v3/texverse_gen_renders"
